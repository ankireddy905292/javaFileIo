...
public class AddressBookManager {
    ...
    public ArrayList<AddressBookMethods> detailedEntries = new ArrayList<>();
    public Map<String, ArrayList<AddressBookMethods>> book = new HashMap<>();
    public Map<String, ArrayList<AddressBookMethods>> multiBook = new HashMap<>();
    public Map<String, ArrayList<AddressBookMethods>> cityList = new HashMap<>();
    public Map<String, ArrayList<AddressBookMethods>> stateList = new HashMap<>();
    public Map<Integer, ArrayList<AddressBookMethods>> zipList = new HashMap<>();
    ...
    public void viewPersonsByCityState() {
        ...
        switch (opt){
            case 1:
                ...
                String location = sc.next();
                Map<String, ArrayList<AddressBookMethods>> cityL =
            ...
            case 2:
                ...
                String state = sc.next();
                Map<String, ArrayList<AddressBookMethods>> stateL =
    ...
    private void callAddressBookTemp(String bookName,
        ...
        AddressBookMethods adder = new AddressBookMethods(bookName, firstName, lastName, address, city, zip, state, phoneNumber, email);
        //adder.toString();
    ...
    public void editContact() {
        ...
        String bookName = sc.next();
        ArrayList<AddressBookMethods> tempContact = multiBook.get(bookName);
        System.out.println("enter your name");
        String name = sc.next();
        for (AddressBookMethods eachDetails : tempContact) {
